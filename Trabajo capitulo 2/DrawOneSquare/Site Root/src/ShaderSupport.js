var gSimpleShader = null; //Guarda la referencia del shader del programa
var gShaderVertexPositionAttribute = null;// guarda el atributo posicion del vertex en memoria
